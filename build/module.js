...
function compile()
{
	const STD_FILE = __dirname + "/../src/sxml/tsconfig.json";
...
{
	const HEAD = __dirname + "/../src/sxml/typings/sxml.d.ts";
	const BODY = __dirname + "/../lib/sxml.d.ts";
...
{
	const JS_FILE = __dirname + "/../lib/sxml.js";
